...
def interactive_edge_detection(image_path):
        ...
        """Interactive edge detection and filtering using Canny algorithm."""
        ...
        while True:
            ...
            if choice == '1':
                ...
                display_image('Laplacian Edge Detection', np.abs(laplacian).astype(np.uint8))(laplacian)
...
interactive_edge_detection('/Users/kohinoor/Desktop/VS Codes/AI Codes/example.jpg')
